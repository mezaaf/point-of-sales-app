...
export default function Dashboard() {
  ...
  const { data: revenue } = useQuery({
    ...
    queryFn: async () => {
      ...
      console.log(totalRevenueLastMonth);
      console.log(totalRevenueThisMonth);
      return {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardTitle>{totalOrder ?? 0}</CardTitle>
          </CardHeader>
          <CardFooter>
            <div className="text-muted-foreground text-sm">
        ...
        <Card>
          <CardHeader>
            ...
            <CardTitle>{revenue?.growthRate ?? 0}%</CardTitle>
          </CardHeader>
          <CardFooter>
            <div className="text-muted-foreground text-sm">
